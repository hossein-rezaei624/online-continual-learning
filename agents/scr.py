...
class SupContrastReplay(ContinualLearner):
    ...
    def train_learner(self, x_train, y_train):
        ...
        top_indices_1 = sorted_indices_1[:int(0.8*top_n)]
        top_indices_2 = sorted_indices_1[-int(0.1*top_n):]
        top_indices_3 = sorted_indices_2[-(top_n - (int(0.8*top_n) + int(0.1*top_n))):]
