        ...
        with torch.no_grad():
            ...
            for task, test_loader in enumerate(test_loaders):
                ...
                for i, (batch_x, batch_y, indices_1) in enumerate(test_loader):
                    ...
                    #batch_x8 = torch.tensor(elastic_transform(glass_blur(batch_x_pil)).astype(float) / 255.0, dtype = batch_x.dtype).to("cuda").permute(2,0,1).reshape(batch_x.shape)
                    ...
                    all_batches = [batch_x, batch_x1, batch_x2, batch_x3, batch_x4, batch_x5]
                    ...
                    images_1 = [batch_x[i] for i in range(6)]
